...
export function UsersTableSkeleton({ rows = 8 }: { rows?: number }) {
  return (
    <div className="bg-card overflow-hidden rounded-lg border" data-slot="users-table-skeleton">
      ...
      {Array.from({ length: rows }).map((_, r) => (
        <div key={r} className="grid grid-cols-6 items-center gap-4 border-b px-4 py-3 last:border-0">
