...
import type { CreateProjectInput } from "../../lib/project-form-schema";

// Shared Add/Edit project form fields — the lead fields plus a Developer field.
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input placeholder="Land developer or estate" {...field} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
