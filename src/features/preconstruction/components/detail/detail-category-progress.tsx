...
import {
  STATIC_CATEGORIES,
  type ProjectCategoryStatus,
} from "../../lib/detail-static";
...
// Category Progress sidebar — design placeholder data (no API). See lib/detail-static.ts.
export function DetailCategoryProgress() {
