...
const sizeSequence = [
  2_500_000, 1_200_000, 5_600_000, 980_000, 158_000_000, 3_400_000, 720_000,
  12_400_000, 4_100_000,
];

export const businessDocuments: BusinessDocument[] = statusSequence.map(
  (status, i) => ({
