...
export function WorkPreferencesStep() {
  const { data, updateWorkPreferences, nextStep, prevStep } =
    useOnboardingStore();
      ...
      <div className="space-y-8">
        <div className="space-y-4">
          ...
          <RadioGroup
            ...
            onValueChange={(value) =>
              updateWorkPreferences({ workStyle: value })
            }
        ...
        <div className="space-y-4">
          ...
          <RadioGroup
            ...
            onValueChange={(value) =>
              updateWorkPreferences({ experience: value })
            }
            className="grid grid-cols-1 gap-4 md:grid-cols-3"
          >
            {[
              ...
              },
              {
                value: "mid",
                label: "Mid Level",
                desc: "3-5 years experience",
                icon: "🚀",
              },
              {
                value: "senior",
                label: "Senior Level",
                desc: "6+ years experience",
                icon: "⭐",
              },
            ].map((option) => (
              <div key={option.value} className="relative">
        ...
        <div className="space-y-4">
          ...
          <RadioGroup
            ...
            onValueChange={(value) =>
              updateWorkPreferences({ availability: value })
            }
            className="grid grid-cols-1 gap-4 md:grid-cols-3"
          >
            {[
